...
python3 convert_images_static.py -p1 ${ROOT}/../darks/${DARKS_D0} -p2 ${ROOT}/../darks/${DARKS_D1} -g1 ${ROOT}/../darks/gainMaps_M524_sc15_2022-05-20.bin -g2 ${ROOT}/../darks/gainMaps_M525_sc15_2022-05-20.bin -i ${ROOT}/../../RAW_DATA/${INP} -o ${ROOT}/${INP};