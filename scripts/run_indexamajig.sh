...
command="indexamajig -i ${ROOT}/lists/${INPUT} -o  ${ROOT}/streams/${OUTPUT} -g ${ROOT}/geoms/JF_regae_v2_converted_calib_231222_16_001_v0.geom --indexing=none"
...
command="$command -j 64 --peaks=zaef --threshold=600 --min-snr=5 --min-squared-gradient=100000 --min-pix-count=3 --max-pix-count=200 --min-res=0 --max-res=1200 --min-peaks=2 --int-radius=6,9,12"
